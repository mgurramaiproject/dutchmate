...
const hebbenEnglishComparison: EnglishMapRecord[] = [
...
const hebbenPack: VerbJourneyPack = {
  schemaVersion: VERB_JOURNEY_SCHEMA_VERSION,
  contentVersion: HEBBEN_VERB_JOURNEY_CONTENT_VERSION,
  verb: { id: "verb.hebben", lemma: "hebben", english: "to have", level: "A1", tags: ["irregular", "core"], auxiliary: "hebben" },
  dutchForms: [
    { id: "form.hebben.ott", dutchTense: "OTT", viewpoint: "present", completion: "onvoltooid", fullNameNl: "onvoltooid tegenwoordige tijd", sentence: "Ik heb vandaag genoeg tijd.", naturalEnglish: "I have enough time today.", usageMeaning: "present possession, availability, or a current state", formula: "ik + heb", commonUsage: "Ik heb tijd. / Heb jij tijd?", cefrLevel: "A1", teachingPriority: "core", status: "next" },
    { id: "form.hebben.vtt", dutchTense: "VTT", viewpoint: "present", completion: "voltooid", fullNameNl: "voltooid tegenwoordige tijd", sentence: "Ik heb vandaag genoeg tijd gehad.", naturalEnglish: "I have had enough time today.", usageMeaning: "a completed possession or experience viewed from the present", formula: "ik + heb + gehad", commonUsage: "Ik heb genoeg tijd gehad.", cefrLevel: "A2", teachingPriority: "later", status: "later" },
    { id: "form.hebben.ovt", dutchTense: "OVT", viewpoint: "past", completion: "onvoltooid", fullNameNl: "onvoltooid verleden tijd", sentence: "Ik had gisteren tijd.", naturalEnglish: "I had time yesterday.", usageMeaning: "past possession, availability, or background state", formula: "ik + had", commonUsage: "Ik had gisteren tijd.", cefrLevel: "A1", teachingPriority: "core", status: "later" },
    { id: "form.hebben.vvt", dutchTense: "VVT", viewpoint: "past", completion: "voltooid", fullNameNl: "voltooid verleden tijd", sentence: "Ik had genoeg tijd gehad.", naturalEnglish: "I had had enough time.", usageMeaning: "a completed possession before another past reference point", formula: "ik + had + gehad", commonUsage: "Ik had al genoeg tijd gehad voordat de vergadering begon.", cefrLevel: "A2", teachingPriority: "later", status: "later" },
    { id: "form.hebben.ottt", dutchTense: "OTTT", viewpoint: "future", completion: "onvoltooid", fullNameNl: "onvoltooid tegenwoordige toekomende tijd", sentence: "Ik zal morgen tijd hebben.", naturalEnglish: "I will have time tomorrow.", usageMeaning: "an explicit future possession or prediction", formula: "ik + zal + hebben", commonUsage: "Morgen heb ik tijd. / Ik zal morgen tijd hebben.", cefrLevel: "A2", teachingPriority: "later", status: "later" },
    { id: "form.hebben.vttt", dutchTense: "VTTT", viewpoint: "future", completion: "voltooid", fullNameNl: "voltooid tegenwoordige toekomende tijd", sentence: "Ik zal de afspraak gehad hebben.", naturalEnglish: "I will have had the appointment.", usageMeaning: "a completed possession or experience before a future reference point", formula: "ik + zal + gehad hebben", commonUsage: "Tegen vrijdag heb ik de afspraak gehad.", cefrLevel: "reference", teachingPriority: "reference", status: "reference" },
    { id: "form.hebben.ovtt", dutchTense: "OVTT", viewpoint: "future-from-past", completion: "onvoltooid", fullNameNl: "onvoltooid verleden toekomende tijd", sentence: "Ik zou morgen tijd hebben.", naturalEnglish: "I would have time tomorrow.", usageMeaning: "a conditional or hypothetical possession", formula: "ik + zou + hebben", commonUsage: "Als ik vrij was, zou ik tijd hebben.", cefrLevel: "A2", teachingPriority: "later", status: "later" },
    { id: "form.hebben.vvtt", dutchTense: "VVTT", viewpoint: "future-from-past", completion: "voltooid", fullNameNl: "voltooid verleden toekomende tijd", sentence: "Ik zou genoeg tijd gehad hebben.", naturalEnglish: "I would have had enough time.", usageMeaning: "an unreal or unrealised completed possession", formula: "ik + zou + gehad hebben", commonUsage: "Als ik eerder was begonnen, zou ik genoeg tijd gehad hebben.", cefrLevel: "reference", teachingPriority: "reference", status: "reference" },
  ],
