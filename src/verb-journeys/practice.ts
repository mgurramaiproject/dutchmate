...
const gaanPracticeSpecs: GaanPracticeSpec[] = [
  { journeyId: "journey.gaan.ott-movement", skillId: "skill.gaan.ott-movement", meaningContext: "Ik ga vandaag naar de markt.", meaningChoices: ["Present movement or a plan", "A completed past movement", "A conditional possibility"], meaningAnswer: "Present movement or a plan", constructionContext: "Complete: Ik ___ vandaag naar de markt.", constructionTokens: ["ga", "gaat", "ging", "ben"], constructionAnswer: "ga", naturalContext: "I am going to the station soon.", naturalChoices: ["Jij gaat straks naar het station.", "Jij ging straks naar het station.", "Jij bent straks naar het station gegaan."], naturalAnswer: "Jij gaat straks naar het station.", mapContext: "Ik ga vandaag naar de markt.", mapChoices: ["OTT · onvoltooid tegenwoordige tijd", "OVT · onvoltooid verleden tijd", "VTT · voltooid tegenwoordige tijd", "OTTT · onvoltooid tegenwoordige toekomende tijd"], mapAnswer: "OTT · onvoltooid tegenwoordige tijd", orderContext: "Start with the time phrase: Vandaag …", orderTokens: ["Vandaag", "ga", "ik", "naar", "de", "markt."], orderAnswer: "Vandaag ga ik naar de markt.", repairContext: "Ik ___ vandaag naar de markt.", repairChoices: ["ga", "gaat", "ging"], repairAnswer: "ga" },
