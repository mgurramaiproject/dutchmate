...
**Issue:** [#190](https://github.com/mgurramaiproject/dutchmate/issues/190)

## What to build

Deliver the A2 companion lesson and topic-level progression so learners can ask for product information, report a simple problem, and receive an A2 next-action recommendation after A1.
