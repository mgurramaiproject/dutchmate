...
**Current T01 state:** Complete on `main`. Evidence: focused learning-record/background tests (27 tests), full suite (92 files / 538 tests), typecheck, Chrome build, Firefox build, and `git diff --check` all pass. PR #78 merged as `493de27`; issue #73 is closed and its Delivery item is `Done`.
...
**Current T02 state:** Complete on `main`. Evidence: focused selection/source/save/helper tests (50 tests), full suite (92 files / 547 tests), typecheck, Chrome build, Firefox build, and `git diff --check` all pass. PR #78 merged as `493de27`; issue #74 is closed and its Delivery item is `Done`.
...
**Current T03 state:** Complete on `main`. Evidence: focused hover/Seen-before/encounter tests (47 tests), full suite (92 files / 557 tests), typecheck, Chrome build, Firefox build, and `git diff --check` all pass. PR #78 merged as `493de27`; issue #75 is closed and its Delivery item is `Done`.
...
**Current T04 state:** Complete on `main`. Evidence: focused popup/Saved/tooltip tests (45 tests), full suite (92 files / 559 tests), typecheck, Chrome build, Firefox build, and `git diff --check` all pass. PR #78 merged as `493de27`; issue #76 is closed and its Delivery item is `Done`.
