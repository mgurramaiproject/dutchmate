...
**Issue:** [#188](https://github.com/mgurramaiproject/dutchmate/issues/188)

## What to build

Deliver the supermarket A1 lesson's multilingual, resumable learning path from topic selection through context, useful sentences, selected chunks and vocabulary, and the `Waar kan ik ... vinden?` language focus.
