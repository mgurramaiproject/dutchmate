...
**Approved direction:** **A — Quiet Index**. Use its editorial numbered rows, stable chronological shelf numbers, compact helper meanings, neutral Mastery labels, and in-place context expansion as the implementation reference.
