# PVR-001: Popup review cards use a local canonical model

Status: accepted

Related plan/spec: `docs/features/PVR-001-plan-popup-vocabulary-review.md` and `docs/features/PVR-001-spec-popup-vocabulary-review-mvp.md`.
