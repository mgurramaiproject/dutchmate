...
- Firefox package: `release/dutchmate-firefox-0.4.0.zip`
- Chromium package for Chrome: `release/dutchmate-chrome-0.4.0.zip`
- Chromium package for Edge: use `release/dutchmate-chrome-0.4.0.zip` unless a separate Edge-specific package is created
- GitHub release notes source: `docs/release/notes/v0.4.0.md`
...
## Current 0.4.0 Artifact Status

Generated locally from the current source:

- `release/dutchmate-firefox-0.4.0.zip`
- `release/dutchmate-chrome-0.4.0.zip`

Older `0.1.x`, `0.2.0`, and `0.3.0` artifacts may still exist locally in `release/` for reference. Use the `0.4.0` artifacts for the current release.

The Firefox source package still needs to be regenerated separately if AMO requests source code for the `0.4.0` submission.
...
4. Upload `release/dutchmate-firefox-0.4.0.zip`.
...
5. Upload `release/dutchmate-chrome-0.4.0.zip`.
