...
- Firefox package: `release/dutchmate-firefox-0.5.1.zip`
- Chromium package for Chrome: `release/dutchmate-chrome-0.5.1.zip`
- Chromium package for Edge: use `release/dutchmate-chrome-0.5.1.zip` unless a separate Edge-specific package is created
...
for reference. Use the `0.5.1` artifacts for the current release.

The Firefox source package is ready if AMO requests source code for the
`0.5.1` submission: `release/dutchmate-firefox-source-0.5.1.zip`.
...
4. Upload `release/dutchmate-firefox-0.5.1.zip`.
...
5. Upload `release/dutchmate-chrome-0.5.1.zip`.
