...
- Firefox package: `release/dutchmate-firefox-0.5.0.zip`
- Chromium package for Chrome: `release/dutchmate-chrome-0.5.0.zip`
- Chromium package for Edge: use `release/dutchmate-chrome-0.5.0.zip` unless a separate Edge-specific package is created
- GitHub Release Edge asset: `release/dutchmate-edge-0.5.0.zip` (the verified
  Chromium package under an Edge-specific filename)
- GitHub release notes source: `docs/release/notes/v0.5.0.md`
...
## Current 0.5.0 Artifact Status

Generated by the GitHub Release workflow from the merged `main` source:

- `release/dutchmate-firefox-0.5.0.zip`
- `release/dutchmate-chrome-0.5.0.zip`
- `release/dutchmate-edge-0.5.0.zip`

Older `0.1.x` through `0.4.0` artifacts may still exist locally in `release/`
for reference. Use the `0.5.0` artifacts for the current release.

The Firefox source package still needs to be regenerated separately if AMO
requests source code for the `0.5.0` submission.
...
4. Upload `release/dutchmate-firefox-0.5.0.zip`.
...
5. Upload `release/dutchmate-chrome-0.5.0.zip`.
